...
<div class="container mt-5">
    <div class="row justify-content-center">
        <div class="col-lg-3 col-md-4 col-sm-6">
            <div class="card h-100 shadow-lg rounded-3 overflow-hidden border-0 hover:scale-105 transition-transform duration-300 text-center">
                ...
                <div class="card-body d-flex flex-column">
                    ...
                    <h6 class="card-subtitle mb-2 text-muted fst-italic">{{ $book->author }}</h6>
